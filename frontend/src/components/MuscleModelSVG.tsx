...
const getColor = (muscleName: string, primaryMuscles: any[] = [], secondaryMuscles: any[] = []) => {
...
const MuscleModelSVG = ({ primaryMuscles = [], secondaryMuscles = [], view = 'front' }) => {
  const c = (name: string) => getColor(name, primaryMuscles, secondaryMuscles);
    ...
    return (
      <View style={{ alignItems: 'center' }}>
        <Svg width="180" height="320" viewBox="0 0 180 320">
          ...
          {/* ABS - 3x2 grid */}
          {/* Row 1 */}
          <Path d="M80 114 L90 114 L90 130 L80 130 Z" fill={c('abs')} stroke={COLORS.outline} strokeWidth="1.2" />
          <Path d="M90 114 L100 114 L100 130 L90 130 Z" fill={c('abs')} stroke={COLORS.outline} strokeWidth="1.2" />
          {/* Row 2 */}
          <Path d="M80 132 L90 132 L90 148 L80 148 Z" fill={c('abs')} stroke={COLORS.outline} strokeWidth="1.2" />
          <Path d="M90 132 L100 132 L100 148 L90 148 Z" fill={c('abs')} stroke={COLORS.outline} strokeWidth="1.2" />
          {/* Row 3 */}
          <Path d="M80 150 L90 150 L90 164 L80 164 Z" fill={c('abs')} stroke={COLORS.outline} strokeWidth="1.2" />
          <Path d="M90 150 L100 150 L100 164 L90 164 Z" fill={c('abs')} stroke={COLORS.outline} strokeWidth="1.2" />
...
export default React.memo(MuscleModelSVG);
