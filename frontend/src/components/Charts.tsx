...
export const WeightLineChart = React.memo(function WeightLineChart({ data = [], width = 300, height = 140 }: { data?: any[], width?: number, height?: number }) {
...
export const WorkoutIntensityBarChart = React.memo(function WorkoutIntensityBarChart({ data = [], width = 300, height = 140 }: { data?: any[], width?: number, height?: number }) {
  const defaultData = [
    { day: 'Mon', volume: 0 },
    { day: 'Tue', volume: 0 },
    { day: 'Wed', volume: 0 },
...
export const CalorieRing = React.memo(function CalorieRing({ consumed = 0, goal = 2000, size = 120 }: { consumed?: number, goal?: number, size?: number }) {
