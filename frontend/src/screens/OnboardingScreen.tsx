            ...
            {weeklyLossGoal && previewTDEE() && (
              <View style={s.previewCard}>
                ...
                <Text style={[s.previewVal, { color: '#FF5722' }]}>
                  {Math.round((previewTDEE() as number) - (Number(weeklyLossGoal) * 7700) / 7)} kcal/day
                </Text>
                <Text style={{ color: '#A1A1AA', fontSize: 12, marginTop: 4 }}>
                  TDEE {previewTDEE()} − {Math.round((Number(weeklyLossGoal) * 7700) / 7)} deficit
                </Text>
              </View>
            )}
          </View>
            ...
            {weight && activityLevel && (
              <View style={[s.previewCard, { borderStyle: 'dashed', backgroundColor: '#161616' }]}>
                ...
                <Text style={[s.previewVal, { color: '#60A5FA' }]}>
                  {(calculateWaterGoal(parseFloat(weight), activityLevel, takesCreatine, parseFloat(creatineDose)) / 1000).toFixed(1)} Liters/day
                </Text>
